...
$app->get('/rm3-gold', function (Req $req, Res $res) use ($publicPath) {
    ...
    $teamData = [
        'team' => [
            ...
            ['name' => 'Ivan Chen', 'position' => 'Setter', 'number' => '70', 'image' => 'https://dummyimage.com/300x300/f8f9fa/b38f14.png&text=70'],
            ['name' => 'Jaiden Bagley', 'position' => 'Opposite', 'number' => '57', 'image' => 'https://dummyimage.com/300x300/f8f9fa/b38f14.png&text=57'],
            ...
            ['name' => 'Stick Antolini', 'position' => 'Libero', 'number' => '73', 'image' => 'https://dummyimage.com/300x300/f8f9fa/b38f14.png&text=73'],
        ],
    ];
